...
def create_wall_maze( x, y ):
	...
	board[7][4].type = CellType.Block
	board[7][3].type = CellType.Block
	board[7][2].type = CellType.Block
	board[6][2].type = CellType.Block
	board[5][2].type = CellType.Block
	board[5][3].type = CellType.Block
	board[7][5].type = CellType.Block
	board[13][4].type = CellType.Block
	board[13][3].type = CellType.Block
	board[13][2].type = CellType.Block
	board[14][4].type = CellType.Block
	board[15][4].type = CellType.Block
	board[15][3].type = CellType.Block
	board[15][2].type = CellType.Block
	board[14][2].type = CellType.Block
